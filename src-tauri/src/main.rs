...
struct TweakDef {
    ...
    tier: &'static str,     // "low" | "medium" | "high"
...
fn tweak_defs() -> Vec<TweakDef> {
    vec![
        ...
        TweakDef {
            ...
            tier: "low",
            effectiveness: "High in DX11 titles with FPS drops; negligible in DX12/Vulkan games.",
            group: "boost", admin: false, reboot: false,
        },
        TweakDef {
            id: "mpo",
            label: "Disable Multiplane Overlay (MPO)",
            help: "Stops the GPU from compositing windows as separate hardware planes. A troubleshooting tweak for flicker, black flashes, or stutter — especially with G-Sync/FreeSync.",
            ...
            tier: "medium",
            effectiveness: "Only helps if you see flicker/black flashes with VRR. No FPS gain otherwise.",
        ...
        TweakDef {
            ...
            tier: "medium",
            effectiveness: "Varies — helps frame pacing on RTX 30+ / RX 6000+, can hurt on older hardware. Benchmark first.",
            group: "permanent", admin: true, reboot: true,
        },
        // ── Timer & CPU ──
        TweakDef {
            ...
            tier: "low",
            effectiveness: "Modest — frees up CPU time for the foreground game. More noticeable on 4-core CPUs.",
        ...
        TweakDef {
            ...
            tier: "low",
            effectiveness: "Helps on laptops with aggressive throttling. Desktop users see little difference.",
            group: "boost", admin: true, reboot: false,
        },
        TweakDef {
            id: "corepark",
            label: "Disable core parking",
            help: "Keeps all CPU cores awake during light load so bursty games don't wait for a parked core to wake. Changes the currently active power plan — apply after the plan swaps to High Performance.",
            ...
            tier: "low",
            effectiveness: "Helps bursty games on CPUs with aggressive parking. Minimal on modern Windows with good power plans.",
            group: "permanent", admin: true, reboot: false,
        },
        TweakDef {
            id: "priority",
            label: "Win32PrioritySeparation 0x1A",
            help: "Makes Windows prefer the foreground process's thread scheduling. Results vary — benchmark before/after. Revert restores the default 0x02.",
            ...
            tier: "medium",
            effectiveness: "Debatable — little solid evidence. May help on systems with heavy background load during gaming.",
            group: "permanent", admin: true, reboot: false,
        },
        TweakDef {
            id: "dynamictick",
            ...
            tier: "medium",
            effectiveness: "Hits and misses — some users report smoother frametime, others see nothing. Hardware-dependent.",
            group: "permanent", admin: true, reboot: true,
        },
        TweakDef {
            id: "hpet",
            ...
            tier: "medium",
            effectiveness: "Inconsistent — can help or hurt depending on motherboard/chipset. Always benchmark.",
            group: "permanent", admin: true, reboot: true,
        },
        // ── Memory & Background ──
        TweakDef {
            ...
            tier: "low",
            effectiveness: "High — frees GPU/CPU cycles used by Aero compositing. Most noticeable on older or integrated GPUs.",
            group: "boost", admin: false, reboot: false,
        },
        TweakDef {
            id: "bgapps",
            ...
            tier: "low",
            effectiveness: "High if you have <8GB RAM or many Store apps running. Negligible on 16GB+ with few Store apps.",
            group: "boost", admin: false, reboot: false,
        },
        TweakDef {
            id: "dvr",
            ...
            tier: "low",
            effectiveness: "Medium — stops a constant background encoder. Helps more on CPU-bound systems.",
            group: "boost", admin: false, reboot: false,
        },
        TweakDef {
            id: "netthrottle",
            ...
            tier: "low",
            effectiveness: "Only helps online games if you're hitting the Windows network throttle. No effect on download speed.",
            group: "boost", admin: true, reboot: false,
        },
        TweakDef {
            id: "sysmain",
            ...
            tier: "low",
            effectiveness: "SSD: near zero. HDD: can reduce random reads during gaming. Check your disk type first.",
            group: "permanent", admin: true, reboot: false,
        },
        TweakDef {
            id: "diag",
            ...
            tier: "low",
            effectiveness: "Low — frees minor CPU/RAM. Primarily a privacy/telemetry choice, not a performance one.",
            group: "permanent", admin: true, reboot: false,
        },
        TweakDef {
            id: "memint",
            ...
            tier: "high",
            effectiveness: "Can improve FPS 3–10% in CPU-bound scenarios by removing hypervisor overhead. Security tradeoff — only disable if you know the risk.",
            group: "permanent", admin: true, reboot: true,
        },
    ]
}
...
fn tweaks_view(settings: &Settings) -> Vec<TweakView> {
    ...
    tweak_defs()
        ...
        .map(|t| TweakView {
            ...
            effectiveness: t.effectiveness.to_string(),
